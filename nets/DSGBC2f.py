...
class GatedConvBottleneck(nn.Module):
    """Gated Convolution Bottleneck with channel reduction for efficiency."""
...
class DSGB(nn.Module):
    """Standard bottleneck with parallel Gated Convolution Bottleneck."""
    ...
    def __init__(self, c1, c2, shortcut=True, e=0.5, reduction_ratio=4):
        ...
        self.gated = GatedConvBottleneck(c1, c2, reduction_ratio)
...
class DSGBC2f(C2f):
    ...
    def __init__(self, c1, c2, n=1, shortcut=False, g=1, e=0.5):
        ...
        self.m = nn.ModuleList(DSGB(self.c, self.c, shortcut, e=1.0) for _ in range(n))
